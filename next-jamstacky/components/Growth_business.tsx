...
async function getData() {
  const query = `*[_type == "growth_business"]{
        _id,
          title,
          question_list,
    }`;
                  ...
                  <div className="pb-8">
                    <Accordion>
                      <AccordionSummary
                        ...
                        id="panel1-header"
                        className="relative text-blue text-[15.75px] xl:text-[18px] font-bold pr-[3rem] sm:pr-[4rem]  font-DM  after:bg-[url(/downArrow.svg)] after:absolute after:top-[50%] after:translate-y-[-50%] after:right-[4%] md:after:right-[2%] after:w-full after:h-[1.1em] after:z-10 after:bg-no-repeat after:bg-[100%] after:transition-all after:duration-[0.2s] py-[0.85rem]  after:!rotate-0 "
                      >
                        {list?.question}
                      </AccordionSummary>
                      <AccordionDetails
                        className="mt-3.5 text-sm xl:text-base text-blue font-DM opacity-70 border-b-[#222549] border-b-[1px] border-opacity-20"
                        aria-hidden="false"
...
export default Growth_business;
