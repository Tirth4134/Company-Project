      ...
      <div className="container">
        <div className="flex justify-between items-center pt-[8em] sm:pt-[10em] pb-0 px-0">
              ...
              <div className="flex xl:items-center  flex-col-reverse xl:flex-row justify-start">
                <h1 className="inline-block text-[25.2px] esm:text-[28.35px]  md:text-[31.5px] emd:text-[40.25px] lg:text-[46px] font-bold leading-[1.25em] lg:max-w-[32rem] text-[#110462] mb-[0.5em] font-DM">
                  ...
                  <div
                    ...
                    before:content-[''] before:bg-none before:bg-no-repeat before:w-[1.5em] before:xl:w-[2em] before:h-[1.1em] before:xl:h-[1.5em] before:absolute  [&>img]:max-w-[auto] sm:[&>img]:max-w-[8.5em] [&>img]:w-full [&>img]:h-full [&>img]:animate-[rotations_30s_linear_infinite]
                    before:top-2/4 before:left-2/4 before:-translate-x-2/4 before:-translate-y-2/4"
                  >
                    <Image src={item?.hero_image} height={100} width={100} alt="hero"/>
                  </div>
              ...
              <div className="banner-btn ">
                <ul className="hover:[&>li>a]:text-[#ffffff] mt-4 block em:flex">
                  <li className="secondary [&>a]:bg-[#222549] hover:[&>a]:bg-[#6A70B2] [&>a]:text-[15.75px] xl:[&>a]:text-[18px] mr-[1em] [&>a]:px-[25px] [&>a]:py-[12px] lg:[&>a]:px-[30px] sm:[&>a]:py-[16px] lg:[&>a]:py-[20px] hover:[&>a]:shadow-banner-btn">
                      ...
                      <Link href={item?.start_project_button.slug.current} className="text-[1.125em] font-bold leading-[1.25em] text-[#ffffff] bg-[#DA3654] hover:bg-dark-blue inline-block cursor-pointer px-[1.3em] py-[0.9em] lg:px-[1.5em] lg:py-[1em] rounded-[3.5em] font-DM  text-center ">{item?.start_project_button.label}</Link>
                  ...
                  <li className="hover:[&>a]:bg-[#FF90A5] ml-0 mt-[0] vsm:ml-4 [&>a]:text-[15.75px] xl:[&>a]:text-[18px] mr-[1em] [&>a]:mt-[1em] em:[&>a]:mt-[0] [&>a]:px-[25px] [&>a]:py-[12px] lg:[&>a]:px-[30px] sm:[&>a]:py-[16px] lg:[&>a]:py-[20px] hover:[&>a]:shadow-banner-btn">
                      ...
                      <Link href={item?.jamstack_developer_button.slug.current} className="text-[1.125em] font-bold leading-[1.25em] text-[#ffffff] bg-[#DA3654] inline-block cursor-pointer px-[0.8em] em:px-[1em] py-[0.75em] md:py-[0.9em] lg:px-[1.5em] lg:py-[1em] rounded-[3.5em] font-DM">{item?.jamstack_developer_button.label}</Link>
          ...
          <div className="lg:w-[40%] hidden lg:block">
              ...
              <div>
                <Image src={item?.title_image} height={500} width={500} alt="title" />
              </div>
