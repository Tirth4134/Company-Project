        ...
        return (
          <div className=" bg-slate-300">
            ...
            <div key={item?._id} className=" ">
                  ...
                  return (
                    <div key={list?._id}>
                      <img  
                        ...
                        height={200}
                      />
                      <button className="">{list?.blog_button}</button>
                      <PortableText value={list?.blog_description} />
                      <Image
                        src={list?.arrow_image.asset.url}
                        alt="arrow"
                        width={20}
                        height={10}
                      />
              ...
              <button className="bg-red-400 text-white item-center rounded w-33 h-8">
                {item?.view_more_blogs_button}
              </button>
            </div>
          </div>
        );
              ...
              return (
                <div>
                          ...
                          />
                              <div>
                                {list?.blog_button.map((btn: any)=>{
                                  ...
                                  return(       
                          <Link href={btn?.slug?.current}>{btn?.label}</Link>
                          )
                        })}
                          </div>
                          <PortableText value={list?.blog_description} />

                          <img  src={urlFor(list?.arrow_image).url()} alt="arrow" width={20} height={10}/>
                        </div>
                  ...
                  <div className="text-center">
                    <Link  className=" mt-[2.75em] mx-auto my-0
                ...
                text-[#fff]" href={item?.view_more_blogs_button.slug.current}>{item?.view_more_blogs_button.label}</Link>
                    </div>
                </div>
              );
            })}
